...
<asp:Content ID="Content" ContentPlaceHolderID="ContentBlock" runat="server">
	<ul class="nav nav-tabs">
		...
		<li class="nav-item"><a class="nav-link active show" href="AttendanceListAdmin">개인별 출석확인</a> </li>
	</ul>
	<form action="/Lecture/AttendanceListExcelAdmin" id="ExcelForm" method="post">
	...
	<form action="/Lecture/AttendanceListAdmin" id="mainForm" method="post">
		<div id="content">
			<div class="card mt-4">
