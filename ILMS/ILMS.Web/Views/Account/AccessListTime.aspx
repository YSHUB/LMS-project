	...
	<div id="content">
        <div>
            <ul class="nav nav-tabs nav">
                <li class="nav-item"><a href="/Account/AccessListTime" class="nav-link active">시간별</a></li>
                <li class="nav-item"><a href="/Account/AccessListDay" class="nav-link">일별</a></li>
                <li class="nav-item"><a href="/Account/AccessListMonth" class="nav-link">월별</a></li>
            </ul>
        </div>
		<div class="row">
			<div class="col-lg-12">
				<div class="card search-form mb-3">
					<div class="card-body">
						<div class="form-row">
							...
							<div class="form-group col-6 col-sm-3 col-lg-3 col-xl-2">
								<label for="ddlDay" class="sr-only">일 :</label>
								<select id="ddlDay" name="Day" class="form-control">
								</select>
							</div>
					...
					<div class="card-body p-0">
						<table class="highchart" data-graph-container-before="1" data-graph-type="column" style="display: none" data-graph-height="300">
							...
							<tr>
								...
								<td>
									<%:Model.StatisticsList.Where(c => c.LoginDay.Hour >= i && c.LoginDay.Hour < (i + 1)).Count()%> 명
								</td>
							</tr>
							<%
							}
						...
						<table class="highchart" data-graph-container-before="1" data-graph-type="column" style="display: none" data-graph-height="300" data-graph-color-1="#228E8E">
							...
							%>
								<tr>
									...
									<td>
										<%:Model.HomeStatisticsList.Where(c => c.NonLoginDay.Hour >= i && c.NonLoginDay.Hour < (i + 1)).Count()%> 회
									</td>
								</tr>
							<%
							}
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(function () {
				...
				for (var i = 1; i < 32; i++) {
					var selectitem = (i == day) ? "selected" : "";
					option += "<option value='" + i + "' " + selectitem + ">" + i + "일" + "</option>";
				}
		...
		$("#btnSearch").click(function () {
			$("#mainForm").attr("action", "/Account/AccessListTime").submit();
		});
