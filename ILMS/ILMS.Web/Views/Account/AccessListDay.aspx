	...
	<div id="content">
        <div>
            <ul class="nav nav-tabs nav">
                <li class="nav-item"><a href="/Account/AccessListTime" class="nav-link">시간별</a></li>
                <li class="nav-item"><a href="/Account/AccessListDay" class="nav-link active">일별</a></li>
					...
					<div class="card-body p-0">
						...
						<table class="highchart" data-graph-container-before="1" data-graph-type="column" style="display: none" data-graph-height="300">
							...
							<tr>
								...
								<td>
									<%:Model.StatisticsList.Where(c => c.LoginDay.Day.Equals(i+1)).Count()%> 명
								</td>
							</tr>
							<%
							}
						...
						<table class="highchart" data-graph-container-before="1" data-graph-type="column" style="display:none" data-graph-height="300" data-graph-color-1="#228E8E">
							...
							<tr>
								...
								<td>
									<%:Model.HomeStatisticsList.Where(c => c.NonLoginDay.Day.Equals(i+1)).Count()%> 회
								</td>
							</tr>
							<%
							}
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptBlock" runat="server">
	...
	<script type="text/javascript">
		...
		$("#btnSearch").click(function () {
			$("#mainForm").attr("action", "/Account/AccessListDay").submit();
		});
