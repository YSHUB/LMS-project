            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" id="txtUserID" name="User.UserID" class="form-control" readonly="readonly" value="<%:Model.User.UserID %>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-4">
                        <label for="" class="form-label">학년(<%:ConfigurationManager.AppSettings["TermText"].ToString() %>)</label>
                        <div class="input-group">
                            <input type="text" id="" name="" class="form-control" readonly="readonly" value="<%:Model.User.GradeName %>">
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-12 col-md-4">
                        <label for="" class="form-label">학적</label>
                        <div class="input-group">
                            <input type="text" id="" name="" class="form-control" readonly="readonly" value="<%:Model.User.HakjeokGubunName %>">
                        </div>
                    </div>
        ...
        <div class="card d-md-block">
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-12 col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" id="" name="User.Mobile" class="form-control" readonly="readonly" value='<%:Model.User.Mobile %>'>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" role="button" href="#" onclick="fnGo()">목록</a>
                </div>
            </div>
        </div>
    </form>
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptBlock" runat="server">
    ...
    <script>
		...
		function fnGo() {
			...
			window.location = "/Account/ListStudent?AssignNo=" + '<%:Model.AssignNo %>' + "&UserType=" + '<%:Model.UserType%>' + "&SearchOption=" + '<%:Model.SearchOption%>' + "&SearchText=" + encodeURIComponent('<%:Model.SearchText%>') + "&PageRowSize=" + <%:Model.PageRowSize%> + "&PageNum=" + <%:Model.PageNum%>;
		}
	</script>
</asp:Content>
