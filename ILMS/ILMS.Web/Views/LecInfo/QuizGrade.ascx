...
<div class="card mt-2" >
    ...
    <div class="card-body p-0">
        <div class="table-responsive_w">
            <table class="table table-bordered table-hover mb-0" summary="">
                <tbody>
                    <tr>
                        ...
                        <th class="text-center" colspan="3">퀴즈
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <%: item.QuizPerfectScore.ToString("F2")%>
                        </td>
                        <td class="text-center">
                            <%: item.QuizScore.ToString("F2")%>
                        </td>
                        <td class="text-center">
                            <%: item.Quiz.ToString("F2")%>
                        </td>
                    </tr>
                    <%
                        }
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#CurrentMenuTitle').text("퀴즈 점수 상세보기");
    });
</script>