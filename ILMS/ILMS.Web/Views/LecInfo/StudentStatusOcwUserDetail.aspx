			...
			<div class="tab-content" id="myTabContent">
				<ul class="nav nav-tabs mt-4" role="tablist">
					<li class="nav-item" role="presentation">
						<a href="/LecInfo/StudentStatusDetail/<%:Model.LectureUserDetail.CourseNo %>/<%:Model.LectureUserDetail.UserNo %>" class="nav-link" role="tab">학습진도 관리</a>
					</li>
					<li class="nav-item" role="presentation">
						<a href="/LecInfo/StudentStatusOcwUserDetail/<%:Model.LectureUserDetail.CourseNo %>/<%:Model.LectureUserDetail.UserNo %>" class="nav-link active" role="tab">콘텐츠 정보</a>
					</li>
				</ul>
			</div>
			<div class="card">
