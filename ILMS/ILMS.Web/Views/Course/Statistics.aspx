...
<asp:Content ID="Content" ContentPlaceHolderID="ContentBlock" runat="server">
	<form id="mainForm" method="post">
		<div id="content">
			...
			<div class="alert bg-light alert-light rounded">
				<p class="font-size-14 text-info font-weight-bold">
					<i class="bi bi-info-circle-fill"></i> 운영 통계 안내
				</p>
				<ul>
					<li class="font-size-14">신청 : 해당 월에 수강 신청한 학생 수</li>
					<li class="font-size-14">수료 : 해당 월에 수료한 학생 수</li>
					<li class="font-size-14">미수료 : 해당 월에 미수료한 학생 수</li>
					<li class="font-size-14">운영강좌 : 운영기간의 마지막 월에 해당하는 강좌 수</li>
				</ul>
			</div>
			<div class="row">
							...
							<div class="table-responsive d-none d-md-block">
								<table class="table table-sm table-horizontal" summary="컨텐츠 통계">
									...
									%>
										...
										<tr class="data">
											<td class="text-center text-nowrap"><%:item.CourseStatisticsGubun %></td>
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptBlock" runat="server">
	<script type="text/javascript">
		...
		$("#btnSearch").click(function () {
			document.forms[0].action = "/Course/Statistics/0";
		...
		$("#btnExcelSave").click(function () {
			if (<%=Model.StatisticsList.Count()%> <= 0) {
				...
				document.forms[0].action = "/Course/CourseStatisticsExcel/0";
				document.forms[0].submit();
			}
		});
