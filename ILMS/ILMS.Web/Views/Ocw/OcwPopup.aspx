...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">콘텐츠 보기</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBlock" runat="server">
    ...
    <form action="/Ocw/SaveOcwOpinion" method="post" id="saveOpForm">
        ...
        <input type="hidden" name="PageNum" id="PageNum" value="<%: Model.PageNum %>" />
        <!-- 의견 페이지개수 -->
    ...
    <form action="/Ocw/OcwPopup" id="mainForm" method="post">
        <div class="p-4">
        <h3 class="title04">콘텐츠 상세</h3>
                ...
                <div class="row align-items-end">
                    <div class="col-12">
                        <dl class="row dl-style02">
                            ...
                            <dd class="col-8 col-md"><span class="pr-2"><%:Model.Ocw.CreateUserName %></span></dd>
                        </dl>
                        <dl class="row dl-style02">
                            <dt class="col-4 col-md-auto w-7rem"><i class="bi bi-dot"></i>전공분류</dt>
                            <dd class="col-8 col-md"><%: Model.Ocw.AssignNamePath %></dd>    
                        </dl>
						<dl class="row dl-style02">
							<dt class="col-4 col-md-auto w-7rem"><i class="bi bi-dot"></i>테마분류</dt>
                            <dd class="col-8 col-md"><%: Model.OcwTheme.ThemeName %></dd>
						</dl>
						<div class="row">
							<div class="col-md-6">
								<dl class="row dl-style02">
						...
						<div class="row">
							<div class="col-md-6">
								<dl class="row dl-style02">
									...
									<dd class="col-2 col-md"><%: Model.Ocw.UsingCount %>
										<span class="badge badge-primary ml-2"><%:Model.OcwLike.LikeCount %> 추천 <i class="bi bi-hand-thumbs-up"></i></span>
										<span class="badge badge-success ml-2"><%:Model.OcwPocket.PocketCount %> 관심 <i class="bi bi-suit-heart"></i></span>
									</dd>
								</dl>
							</div>
							<div class="col-md-6">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="rel-tab" data-toggle="tab" href="#rel" role="tab" aria-controls="rel" aria-selected="false" <%--onclick="tapForm('connect')--%>">연계 콘텐츠 
            ...
            <div class="tab-pane fade" id="rel" role="tabpanel" aria-labelledby="rel-tab">
                <h3 class="title04 mt-3">작성자 추천 리스트</h3>
                            ...
                            <div class="row no-gutters align-items-md-stretch">
                                ...
                                <div class="col-md-8 col-lg-9 pl-md-4">
                                    <div class="text-secondary d-flex flex-wrap align-items-center">
                                        ...
                                        <a href="#" onclick="viewOcw(2840, 1, 5, '/20211008/Contents/20211008142029096.png', 262569, 560, 315, 'frmpop');"
                                            title="강의 바로보기" class="font-size-20 text-point">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>
                                    </div>
                                    <div class="my-1 text-truncate">
                                        <a href="/Ocw/OcwPopup/<%: OcwRecomm.OcwNo %>" class="text-dark">
                ...
                <!-- 기타 추천 -->
                <hr class="line-gap">
                <h3 class="title04 mt-2">기타 추천 리스트</h3>
                <%
                                        ...
                                        <div class="col-12 col-md">
                                            ...
                                            %>
                                                <strong class="text-primary font-size-16">
													<span class="badge badge-primary mr-2">작성자 등록123</span>
												</strong>
                                            <%
                                                }
                                            %>
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptBlock" runat="server">
    <script type="text/javascript">
        ...
        function fnRefresh(tapIdx) {
            tapIdx = tapIdx || "";
            location.href = "/Ocw/OcwPopup/<%:Model.Ocw.OcwNo %>?tapIdx=" + tapIdx;
        }
        ...
        function fnSnsShare(idx) {
            ...
            if (id == "twitter") {
				window.open("https://twitter.com/home?status=" + baseURL + "/Ocw/OcwPopup/<%: Model.Ocw.OcwNo%>", "", "width=500, height=500");
            }
            else if (id == "facebook") {
				window.open("https://www.facebook.com/sharer/sharer.php?u=" + baseURL + "/Ocw/OcwPopup/<%: Model.Ocw.OcwNo %>&amp;src=sdkpreparse", "", "width=500, height=500");
            }
            else if (id == "kakaostory") {
                bootAlert('준비중입니다.');
            }
            else if (id == "naverblog") {
				var url = encodeURI(encodeURIComponent("" + baseURL + "/Ocw/OcwPopup/<%: Model.Ocw.OcwNo%>"));
                ...
                if (IE) {
					window.clipboardData.setData("Text", "" + baseURL + "/Ocw/OcwPopup/<%: Model.Ocw.OcwNo %>");
            }
            else {
					temp = prompt("Ctrl+C를 눌러 클립보드로 복사하세요", "" + baseURL + "/Ocw/OcwPopup/<%: Model.Ocw.OcwNo %>");
                }
            }
        }
        ...
        function fnSetTag(obj) {
            ...
            $("#moveAction").attr("action", "/Ocw/Index").submit();
            fnPrevent();
        }

        //전공 검색
        function fnSetAssign(assignNo) {
