...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBlock" runat="server">
    ...
    <form action="/Ocw/WriteAdmin" id="mainForm" method="post" enctype="multipart/form-data">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab2" href="#" data-toggle="tab" role="tab" aria-controls="tab2" aria-selected="false"
                        onclick="javascript:location.href='/Ocw/CourseListAdmin/<%:Model.Ocw.OcwNo%>'">강의연계</a>
                </li>
            </ul>
        </div>
                        ...
                        <div class="col-12">
                            <div class="form-row">
                                ...
                                <div id="firstPage" class="form-group col-12 col-md-6 d-none">
                                    ...
                                    <input id="txtXIDstart" type="text" name="XIDstart" class="form-control mb-1" placeholder="시작페이지" />
                                </div>

                                <div class="col-12">
                                    <div id="ocwSrcType01" class="alert alert-light border-light d-none">
                                        <p class="font-size-14 text-primary mb-0">
                                            <i class="bi bi-info-circle-fill"></i>외부 홈페이지에서 운영되고 있는 콘텐츠/웹페이지들을 연결할 경우 선택하며, 해당 콘텐츠의 URL 주소만 입력하면 됩니다.
										<br />
                                ...
                                <div class="form-group col-12 col-md-6 <%: ConfigurationManager.AppSettings["UnivYN"].ToString().Equals("N") ? "d-none" : "" %>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="form-control" id="txtDescText" name="Ocw.DescText" rows="5"><%: Html.Raw(Server.UrlDecode((Model.Ocw.DescText ?? "").Replace(System.Environment.NewLine, "<br />")))%></textarea>

                                </div>
                            </div>
                            <div class="alert alert-light border-light">
                                <p class="font-size-14 text-primary mb-0">
                                    <i class="bi bi-info-circle-fill"></i>콘텐츠의 저작권에 유의하시기 바랍니다. 본인 저작물이 아닌 경우 본 사이트에 업로드하는 것은 불법이며, 웹페이지 또는 소스코드로만 등록 가능합니다. 단, 수업용으로만 활용할 경우 제한적으로 업로드가 가능하며 공개여부에서 반드시 강의전용을 선택하십시오.
                                </p>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-12">
                            ...
                            <div class="alert alert-light border-light">
                                <p class="font-size-14 text-primary mb-0">
									...
									<%
										if (ConfigurationManager.AppSettings["UnivYN"].ToString().ToString().Equals("N"))
										{
									%>
                                        Ex) 공학,IT,로봇
                                    <%
                                        ...
                                        <table id="OcwList" class="table table-hover " cellspacing="0" summary="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="LinkOcwNo" id="chkId_<%:Model.OcwList.IndexOf(myOcw) %>" class="checkbox enableAllCheck" value="<%:myOcw.OcwNo %>" type="checkbox" />
                                                    </td>
                                                </tr>
                                                <%
                                                    }
    ...
    <script type="text/javascript">
        ...
        function fnCbGetMyOcwList() {
            ...
            if (ajaxResult.length > 0) {
                ...
                html += "<tr>";
                html += "<td colspan=\"3\" class=\"text-center\">조회된 OCW가 없습니다.";
                html += "</td>";
                html += "</tr>";
            }
        ...
        function fnSaveOcwReg() {
            ...
            if ($("#txtContNm").length < 1 || $.trim($("#txtContNm").val()) == "") {
                ...
                if (openFlag) {
                    if (confirm("현재 공개여부가 '전체공개' 상태입니다. 이대로 저장하시겠습니까?")) {
                        openFlag = false;
                    }
                }

                if (!openFlag) {
                    if ($("#ocwSourceType option:selected").attr("id") == "CTRB002"
                        && ($("#txtOcwData").val().indexOf('https://www.youtube.com') < 0 || $("#txtOcwData").val().indexOf('http://www.youtube.com') < 0)) {
                        if (confirm('유튜브 유튜브 링크에 www가 붙어 있지 않은 경우 출석체크가 정상적으로 되지 않을 수 있습니다'
                            + '\nex1) src="https://www.youtube.com/영상아이디~" : 정상작동'
                            + '\nex2) src="https://youtube.com/영상아이디~" : 출석체크 누락 가능성 있음'
                            + '\n\n계속하시겠습니까?')) {
                ...
                if (!openFlag && !youtubeFlag) {
                    ...
                    $("#txtDescText").val(encodeURIComponent($("#txtDescText").val()));
