...
<asp:Content ID="Content" ContentPlaceHolderID="ContentBlock" runat="server">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link  active show" href="ImportCourse">분반정보</a> </li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h3 class="card-header-title">강좌정보 연동</h3>
                </div>
                <div class="card-body">
                    <div class="form-row">
                        <div class="col-8">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-primary">강좌정보 확인</button>
                        </div>
                    </div>
                </div>
            </div>
