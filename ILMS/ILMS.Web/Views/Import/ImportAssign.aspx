...
<asp:Content ID="Content" ContentPlaceHolderID="ContentBlock" runat="server">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active show" href="ImportAssign">소속정보</a> </li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row mt-2">
                        <div class="col">
                            <h3 class="card-header-title">소속정보 연동</h3>
                        </div>
                        <div class="col-auto text-right">
                            <button type="button" class="btn btn-primary">소속정보 확인</button>
                        </div>
                    </div>
                </div>
            </div>
