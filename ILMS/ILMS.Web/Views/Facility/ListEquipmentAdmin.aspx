...
<asp:Content ID="Content" ContentPlaceHolderID="ContentBlock" runat="server">
	<form action="/Facility/ListEquipmentAdmin" id="mainForm" method="post">
		<div id="content">
			<div class="card mt-4">
				<div class="card-body pb-1">
					<div class="form-row align-items-end">
						...
						<div class="form-group col-sm-auto <%:Model.FacilityList.Count > 0 ? "" : "d-none" %>">
							<input type="button" class="btn btn-secondary" value="유료예약 승인 관리" onclick="fnOpenPopup('/Facility/ListBannedAdmin', 'ContPop', 850, 800, 0, 0, 'auto');">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-12 mt-2">
					<%
						...
						{
					%>
					<div class="alert bg-light alert-light rounded text-center mt-2"><i class="bi bi-info-circle-fill"></i> 등록된 장비가 없습니다.</div>
					<%
						}
						else
						{
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptBlock" runat="server">
	<script type="text/javascript">
		...
		function fnOpenWriteAdmin(FacilityNo) {
            fnOpenPopup("/Facility/WriteAdmin/EQUIPMENT/" + FacilityNo, "ContPop", 850, 800, 0, 0, "auto");
		}
