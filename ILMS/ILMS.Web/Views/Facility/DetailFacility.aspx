...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptBlock" runat="server">
	...
	<script type="text/javascript">
		...
		function fnReserve() {
			...
			var startDate = new Date($("#hdnDate").val());
			var endDate = new Date($("#hdnDate").val());
			var curDate = new Date('<%:DateTime.Now.ToString("yyyy-MM-dd")%>');
			...
			if (curDate < startDate || curDate > endDate) {
				bootAlert("예약은 예약일자로부터 30일 전부터 3일 전까지 가능합니다.<br/> 관리자에게 문의해주세요.");
				return;
			}
