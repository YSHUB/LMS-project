...
<asp:Content ID="Content" ContentPlaceHolderID="ContentBlock" runat="server">
	<form action="/Facility/ListFacility" id="mainForm" method="post">
		<div id="content">
			<%="" %>
				...
				<div class="card-body pb-1">
					<div class="form-row align-items-end">
						...
						<div class="form-group col-md">
							...
							<input id="Search_Text" title="시설명으로 검색" type="text" class="form-control" name="SearchText" value="<%:!string.IsNullOrEmpty(Model.SearchText) ? Model.SearchText : "" %>" placeholder="시설명으로 검색">
						</div>
			...
			<div class="row mt-4">
				<%
					...
					{
				%>
				<div class="col-12 alert bg-light alert-light rounded text-center mt-2"><i class="bi bi-info-circle-fill"></i> 등록된 시설이 없습니다.</div>
				<%
					}
					else
					{
				...
				<div class="col-md-4">
					<div class="card card-style04">
						<div class="card-body">
							<a href="/Facility/DetailFacility/<%:item.FacilityNo %>?Category=<%:Model.Category %>&SearchText=<%:Model.SearchText %>&PageRowSize=<%:Model.PageRowSize%>&PageNum=<%:Model.PageNum%>">
								<div class="img-thumb">
									<%
