	...
	<div class="content">
		<div class="card card-style02">
			...
			<div class="card-body">
				...
				%>
					<dl class="row dl-style02">
						<dt class="col-3 col-md-3 w-5rem text-dark"><i class="bi bi-dot"></i><%:ConfigurationManager.AppSettings["TermText"].ToString() %>(기간)</dt>
						<dd class="col-3 col-md-3"><%:Model.ExamDetail.TermYear + "-" + Model.ExamDetail.TermQuarterName %></dd>
						<dt class="col-3 col-md-3 w-5rem text-dark"><i class="bi bi-dot"></i>분반</dt>
						<dd class="col-3 col-md-3"><%: Model.ExamDetail.ClassNo.ToString() %></dd>
					</dl>
					<dl class="row dl-style02">
						<dt class="col-3 col-md-3 w-5rem text-dark"><i class="bi bi-dot"></i>학년</dt>
						<dd class="col-3 col-md-3"><%:Model.ExamDetail.TargetGradeName %></dd>
						<dt class="col-3 col-md-3 w-5rem text-dark"><i class="bi bi-dot"></i>학점</dt>
						<dd class="col-3 col-md-3"><%:Model.ExamDetail.Credit %></dd>
					</dl>
					<dl class="row dl-style02">
						<dt class="col-3 col-md-3 w-5rem text-dark"><i class="bi bi-dot"></i>수강인원</dt>
						<dd class="col-3 col-md-3"><%:Model.ExamDetail.TotalStudentCount %></dd>
